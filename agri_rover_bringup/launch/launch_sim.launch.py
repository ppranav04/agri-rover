...
def generate_launch_description():
    ...
    namePackage = 'agri_rover_description'  # <--- CHANGE IF NEEDED
    modelFileRelativePath = "urdf/robots/agrirover.urdf.xacro"
    ...
    bridge_params = os.path.join(
        get_package_share_directory('agri_rover_gazebo'),
        'parameters',
